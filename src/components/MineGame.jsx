...
const MinesGame = () => {
  ...
  return (
    <>
    <div className="flex bg-white/20 pt-5 pl-7 pr-7 text-white w-full justify-center  h-[750px] ">
      <div className="w-[450px] bg-[#120916] p-7 pt-7 pb-7  flex rounded-l-[40px] flex-col justify-start font-semibold">
        {/* <div className="mb-4">
