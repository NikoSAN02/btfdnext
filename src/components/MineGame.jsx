    ...
    <div className="flex bg-white/20 pt-5 pl-7 pr-7 text-white w-full justify-between  h-auto ">
      <div className="w-[450px] bg-[#120916] p-5 pt-7 pb-7  flex rounded-[20px] flex-col justify-center">
        ...
        <button
          ...
          className={`w-2/4 ${gameStarted ? 'bg-gradient-to-r from-[#7831DA] to-[#FF1AF0]' : 'bg-[#2E262D]'}  text-white p-2 rounded-[19px] mb-4 hover:bg-gradient-to-r from-[#7831DA] to-[#FF1AF0] transition duration-200`}
